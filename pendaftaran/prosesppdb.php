...
$insert = "insert into pendaftaran(no_pendaftaran,nama_lengkap,nisn,lap_bi_1,lap_bi_2,lap_bi_3,lap_bi_4,lap_bi_5,rata_lap_bi,lap_mtk_1,lap_mtk_2,lap_mtk_3,lap_mtk_4,lap_mtk_5,rata_lap_mtk,lap_bing_1,lap_bing_2,lap_bing_3,lap_bing_4,lap_bing_5,rata_lap_bing,lap_ipa_1,lap_ipa_2,lap_ipa_3,lap_ipa_4,lap_ipa_5,rata_lap_ipa,lap_ips_1,lap_ips_2,lap_ips_3,lap_ips_4,lap_ips_5,rata_lap_ips,rata_lap_total,sertifikat1,sertifikat2,sertifikat3,sertifikat4,sertifikat5,rata_sertifikat,ket) values ('$no_pendaftaran','$nama_lengkap','$nisn','$lap_bi_1','$lap_bi_2','$lap_bi_3','$lap_bi_4','$lap_bi_5','$rata_lap_bi','$lap_mtk_1','$lap_mtk_2','$lap_mtk_3','$lap_mtk_4','$lap_mtk_5','$rata_lap_mtk','$lap_bing_1','$lap_bing_2','$lap_bing_3','$lap_bing_4','$lap_bing_5','$rata_lap_bing','$lap_ipa_1','$lap_ipa_2','$lap_ipa_3','$lap_ipa_4','$lap_ipa_5','$rata_lap_ipa','$lap_ips_1','$lap_ips_2','$lap_ips_3','$lap_ips_4','$lap_ips_5','$rata_lap_ips','$rata_lap_total','$sertifikat1','$sertifikat2','$sertifikat3','$sertifikat4','$sertifikat5','$rata_sertifikat','$ket');";
$insert_query=mysql_query($insert);
if($insert_query){

echo "<h3> Status : anda telah berhasil mengimputkan data</h3>";
}else{
echo "<h3><font color=\"red\">Status : Anda gagal!! mengimputkan data</font><h3>";}
?>
