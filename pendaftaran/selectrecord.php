...
$select="select * from pendaftaran order by no_pendaftaran desc";
...
<tr><th width="1%">NO</th><th width="4%">No Pendaftaran</th><th width="8%">Nama Lengkap </th><th width="4%"> NISN </th><th width="2%"> BI SEM 1</th><th width="2%"> BI SEM 2</th><th width="2%"> BI SEM 3</th><th width="2%"> BI SEM 4</th><th width="2%"> BI SEM 5</th><th width="3%"> RATA2 BI SEM </th>    <th width="2%"> MTK SEM 1</th><th width="2%"> MTK SEM 2</th><th width="2%"> MTK SEM 3</th><th width="2%"> MTK SEM 4</th><th width="2%"> MTK SEM 5</th><th width="3%"> RATA2 MTK SEM</th>  <th width="2%"> BING SEM 1</th><th width="2%"> BING SEM 2</th><th width="2%"> BING SEM 3</th><th width="2%"> BING SEM 4</th><th width="2%"> BING SEM 5</th><th width="3%"> RATA2 BING</th>  <th width="2%">IPA SEM 1</th><th width="2%"> IPA SEM 2</th><th width="2%"> IPA SEM 3</th><th width="2%"> IPA SEM 4</th><th width="2%"> IPA SEM 5</th><th width="3%"> RATA2 IPA</th>  <th width="2%"> IPS SEM 1</th><th width="2%"> IPS SEM 2</th><th width="2%"> IPS SEM 3</th><th width="2%"> IPS SEM 4</th><th width="2%"> IPS SEM 5</th><th width="3%"> RATA2 IPS </th> <th width="4%"> RATA2 RAPOR </th> <th width="3%"> NILAI SERTIFIKAT </th> <th width="7%">ACTION</th></tr>
<?php
$no=1;
...
<td>
<form method=\"POST\" action=\"action.php?no_pendaftaran=$no_pendaftaran\"><input type=\"hidden\" value=\"$no_pendaftaran\" name=\"no_pendaftaran\">
